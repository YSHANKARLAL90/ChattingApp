...
import { Box, ButtonGroup,Button, Drawer, Grid, IconButton, Stack, TextField, Tooltip,Typography, Backdrop } from '@mui/material';
...
const GroupsList = ({w="100%",myGroups = [],chatId}) => (
  ...
  >
    {
      myGroups.length > 0 ? (myGroups.map((group)=><GroupsListItem group={group} chatId={chatId} key={group._id}/>)) : (
